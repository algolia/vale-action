...
class CheckRunner {
    ...
    runUpdateCheck(client, checkRunId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (annotations.length > 0) {
                ...
                yield this.postBotComment(client, 'Beep boop i\'m a bot 🤖', options);
    ...
    botCommentID(client, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const currentComments = yield client.request(`POST /repos/${options.owner}/${options.repo}/issues/${prNumber}/comments`, {
                owner: options.owner,
                repo: options.repo,
                issue_number: prNumber,
            });
